...
if __name__ == '__main__':
    ...
    alternate_Network.immunize_random_nodes(k=200)
    ...
    plot.title("Plot for Simultaion of virus Propogation for \n alternate immunized contact network using plolicy A")
    plot.axhline(y=mean_infected, linewidth=1, color="r",ls='dashed')
    plot.text(1, mean_infected-50 ,'Average number of infected Nodes after 10 runs:' +str(mean_infected))
    plot.show()