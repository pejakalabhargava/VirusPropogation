...
if __name__ == '__main__':
    ...
    virusStrength = [virus_propogation.getEffectiveStrengthOfVirus(beta=val, delta=0.7) for val in betaList]
    print(virusStrength)
    ...
    plot.title("Plot for varying Beta with delta=0.7 for static graph")
    minimumBetaForEpidemic = 0.7/virus_propogation.eigenVal;
